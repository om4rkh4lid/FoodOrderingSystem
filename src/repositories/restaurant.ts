  ...
  private reduceRestaurants = (queryResult: any[]): Restaurant[] => {
    const restaurants = queryResult.reduce<Restaurant[]>((finalResult, currentValue) => {
      ...
      if (found) {
        ...
        finalResult.push(new Restaurant(currentValue.restaurant_id, currentValue.name, currentValue.delivery_time, [currentValue.category_name], currentValue.photo_url));
      }
